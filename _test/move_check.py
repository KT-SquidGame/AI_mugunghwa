...
# 시작하면 눈을 가린다
timer.callback_after(func=start_blind, after=2)
# start_blind()
...
while cap.isOpened():
    ...
    if player_status != 'alive':
        cv2.putText(mask, text='YOU DIED', org=(10, 30), fontFace=cv2.FONT_HERSHEY_SIMPLEX, fontScale=1, color=(127,127,127), thickness=2)
        cv2.putText(img, text='YOU DIED', org=(10, 30), fontFace=cv2.FONT_HERSHEY_SIMPLEX, fontScale=1, color=(0,0,255), thickness=2)
